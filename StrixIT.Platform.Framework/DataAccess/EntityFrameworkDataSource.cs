...
namespace StrixIT.Platform.Framework
{
    ...
    public abstract class EntityFrameworkDataSource : DbContext, IDataSource
    {
        ...
        /// </param>
        protected EntityFrameworkDataSource(IConfiguration config, string connectionStringName) : base(GetConnection(config, connectionStringName))
        {
        }
        ...
        private static string GetConnection(IConfiguration config, string connectionStringName)
        {
