...
namespace System.Linq.Dynamic
{
    ...
    {
        #region Dynamic Join, found at http://stackoverflow.com/questions/12496503/dynamic-linq-c-sharp-with-multiple-joins.
        ...
        #endregion Dynamic Join, found at http://stackoverflow.com/questions/12496503/dynamic-linq-c-sharp-with-multiple-joins.
    ...
    public static class DynamicExpression
    {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1006:DoNotNestGenericTypesInMemberSignatures"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1715:IdentifiersShouldHaveCorrectPrefix", MessageId = "T"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "S")]
    ...
    internal class ClassFactory
    {
        ...
        private ConcurrentDictionary<Signature, Type> classes;
        ...
        public Type GetDynamicClass(IEnumerable<DynamicProperty> properties)
        {
            ...
            try
            {
                ...
                if (!classes.TryGetValue(signature, out type))
                {
                    ...
                    classes.GetOrAdd(signature, type);
                }
                return type;
            }
            finally
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1032:ImplementStandardExceptionConstructors"), SuppressMessage("Microsoft.Usage", "CA2237:MarkISerializableTypesWithSerializable"), ExcludeFromCodeCoverage]
...
#pragma warning restore 0219
        ...
        private Expression ParseOuterIt()
        {
            if (outerIt == null)
            {
                ...
                if (outerIt == null)
                {
                    throw ParseError(Res.NoOuterItInScope);
                }
            }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1800:DoNotCastUnnecessarily"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1500:VariableNamesShouldNotMatchFieldNames", MessageId = "text")]
    ...
    {
        public static readonly string DuplicateIdentifier = "The identifier '{0}' was defined more than once";
        public static readonly string ExpressionTypeMismatch = "Expression of type '{0}' expected";
        public static readonly string ExpressionExpected = "Expression expected";
        public static readonly string InvalidCharacterLiteral = "Character literal must contain exactly one character";
        public static readonly string InvalidIntegerLiteral = "Invalid integer literal '{0}'";
        public static readonly string InvalidRealLiteral = "Invalid real literal '{0}'";
        public static readonly string UnknownIdentifier = "Unknown identifier '{0}'";
        public static readonly string NoItInScope = "No 'it' is in scope";
        public static readonly string NoOuterItInScope = "No 'outerIt' is in scope";
        public static readonly string IifRequiresThreeArgs = "The 'iif' function requires three arguments";
        public static readonly string FirstExprMustBeBool = "The first expression must be of type 'Boolean'";
        public static readonly string BothTypesConvertToOther = "Both of the types '{0}' and '{1}' convert to the other";
        public static readonly string NeitherTypeConvertsToOther = "Neither of the types '{0}' and '{1}' converts to the other";
        public static readonly string MissingAsClause = "Expression is missing an 'as' clause";
        public static readonly string ArgsIncompatibleWithLambda = "Argument list incompatible with lambda expression";
        public static readonly string TypeHasNoNullableForm = "Type '{0}' has no nullable form";
        public static readonly string NoMatchingConstructor = "No matching constructor in type '{0}'";
        public static readonly string AmbiguousConstructorInvocation = "Ambiguous invocation of '{0}' constructor";
        public static readonly string CannotConvertValue = "A value of type '{0}' cannot be converted to type '{1}'";
        public static readonly string NoApplicableMethod = "No applicable method '{0}' exists in type '{1}'";
        public static readonly string MethodsAreInaccessible = "Methods on type '{0}' are not accessible";
        public static readonly string MethodIsVoid = "Method '{0}' in type '{1}' does not return a value";
        public static readonly string AmbiguousMethodInvocation = "Ambiguous invocation of method '{0}' in type '{1}'";
        public static readonly string UnknownPropertyOrField = "No property or field '{0}' exists in type '{1}'";
        public static readonly string NoApplicableAggregate = "No applicable aggregate method '{0}' exists";
        public static readonly string CannotIndexMultiDimArray = "Indexing of multi-dimensional arrays is not supported";
        public static readonly string InvalidIndex = "Array index must be an integer expression";
        public static readonly string NoApplicableIndexer = "No applicable indexer exists in type '{0}'";
        public static readonly string AmbiguousIndexerInvocation = "Ambiguous invocation of indexer in type '{0}'";
        public static readonly string IncompatibleOperand = "Operator '{0}' incompatible with operand type '{1}'";
        public static readonly string IncompatibleOperands = "Operator '{0}' incompatible with operand types '{1}' and '{2}'";
        public static readonly string UnterminatedStringLiteral = "Unterminated string literal";
        public static readonly string InvalidCharacter = "Syntax error '{0}'";
        public static readonly string DigitExpected = "Digit expected";
        public static readonly string SyntaxError = "Syntax error";
        public static readonly string TokenExpected = "{0} expected";
        public static readonly string ParseExceptionFormat = "{0} (at index {1})";
        public static readonly string ColonExpected = "':' expected";
        public static readonly string OpenParenExpected = "'(' expected";
        public static readonly string CloseParenOrOperatorExpected = "')' or operator expected";
        public static readonly string CloseParenOrCommaExpected = "')' or ',' expected";
        public static readonly string DotOrOpenParenExpected = "'.' or '(' expected";
        public static readonly string OpenBracketExpected = "'[' expected";
        public static readonly string CloseBracketOrCommaExpected = "']' or ',' expected";
