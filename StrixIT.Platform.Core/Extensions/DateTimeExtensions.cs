...
namespace StrixIT.Platform.Core
{
    ...
    public static class DateTimeExtensions
    {
        ...
        /// <summary>
        /// Checks whether the datetime occurs at or after the start date and before the end date,
        /// when specified.
        /// </summary>
        ...
        /// <returns>
        /// True if the datetime occurs at or after the start date and before the end date, false otherwise
        /// </returns>
